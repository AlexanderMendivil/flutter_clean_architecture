import 'package:clean_architecture/data.network/entity/movie_entity.dart';
import 'package:clean_architecture/domain/exception/mapper_exception.dart';
import 'package:clean_architecture/domain/model/movie.dart';
  ...
  Movie toMovie(MovieEntity entity){
    ...
    try{
      return Movie(
        ...
        releaseDate: DateTime(entity.releaseDate.year, entity.releaseDate.month, entity.releaseDate.day)
      );
